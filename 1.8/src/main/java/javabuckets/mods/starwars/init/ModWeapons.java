...
import javabuckets.mods.starwars.item.weapons.*;
...
public class ModWeapons 
{
	...
	public static Item redCrossGuardLightsaber;
	/** 
	...
	public static void init()
	{
		...
		redCrossGuardLightsaber = new ItemLightsaberCross().setUnlocalizedName("crossguard_lightsaber").setFull3D();
		GameRegistry.registerItem(redCrossGuardLightsaber, "crossguard_lightsaber", Reference.MOD_ID);
