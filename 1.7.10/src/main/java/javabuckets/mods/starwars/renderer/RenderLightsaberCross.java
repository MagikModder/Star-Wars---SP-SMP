...
import javabuckets.mods.starwars.model.item.ModelLightsaberCross;
...
public class RenderLightsaberCross implements IItemRenderer
{
	protected ModelLightsaberCross model;

	public RenderLightsaberCross()
	{
		model = new ModelLightsaberCross();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) 
	{
		...
		{
			GL11.glPushMatrix();
			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Reference.MOD_ID, "textures/models/lightsaber_cross_guard.png"));
			...
			if (item.hasTagCompound() && item.getTagCompound().getBoolean("active"))
			{
				...
				if (item.getItem() == ModWeapons.redCrossGuardLightsaber) {afloat[0] = 1.0F; afloat[1] = 0.0F; afloat[2] = 0.0F;}
